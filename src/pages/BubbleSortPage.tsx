...
export const BubbleSortPage: React.FC<BubbleSortPageProps> = ({ onBack, onHome, onCatalog }) => {
    ...
    const handleVisualize = () => {
        try {
            ...
            setTrace(generateBubbleSortTrace(numbers));
            setError(null);
        } catch (err: any) {
    ...
    const handleRandomize = () => {
        ...
        setTrace(generateBubbleSortTrace(randomNumbers));
        setError(null);
    };
            ...
            <header className="h-20 border-b border-white/10 backdrop-blur-md bg-[#050505]/80 flex items-center justify-between px-6 sticky top-0 z-50">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h1 className="font-black text-xl tracking-tight text-white uppercase leading-none">Bubble Sort <span className="text-primary text-xs ml-2">Active Insight</span></h1>
                    </div>
                </div>
            ...
            <main className="flex-1 flex flex-col p-6 gap-6 relative z-10 max-w-6xl mx-auto w-full">
                ...
                {!trace ? (
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                        ...
                        <Visualizer
                            trace={trace}
                            onReset={() => setTrace(generateBubbleSortTrace(input.split(',').map(n => parseInt(n.trim()))))}
                        />
                    </div>
                )}
            </main>
